...
2.	What data cleaning, if any, did you perform on the dataset?
  ...
  - For the model estimation, I transformed spend and transaction variables into logs, for better interpretation of the results (percentages increases/decreases).
