...
$$ WebTransactions_{i,t} = \beta_0 + \beta_1OwnedStores_{i,t} + \beta_2PercentageDiscount_{i,t} + \beta_3AffiliateSpend_{i,t} + \beta_4EmailSpend_{i,t} + \beta_5BrandedSearchSpend_{i,t} + \beta_6UnbrandedSearchSpend_{i,t} + \beta_7CompetitiveStores_{i,t} + \gamma_{Year}Year_{t} + \gamma_{Month}Month_{t} + u_{i,t} $$
